...
public class UserManagementServiceImpl implements UserManagementService {
    ...
    @Override
    public void stopFollwing(String currentUserLogin, String userLoginToUnFollow) {
        dao.stopFollowing(currentUserLogin, userLoginToUnFollow);
    }

    @Override
    public Set<AppUser> getFollowedUser(String currentUserLogin) {
        return dao.getFollowedUsers(currentUserLogin);
    }

    @Override
    public Set<AppUser> getNotFollowedUser(String currentUserLogin) {
    ...
    @Override
    public boolean isUserMailAvailable(String mail) {
        try {
            dao.getUserByLogin(mail);
            return false;
        } catch (NoResultException e) {
            return true;
        }
